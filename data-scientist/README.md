...
/plugin install data-scientist@awesome-claude-cowork-plugins
```
...
- **Data Scientist AI Prompts — coming soon.** Want the done-for-you setup (prompts, templates, and a ready-to-use Claude Project)? Join the waitlist and we'll email you the moment it ships: https://theaicareerlab.com/waitlist/data-scientist
