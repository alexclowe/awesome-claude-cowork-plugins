...
You understand how to create educationally relevant speech-language pathology documentation. When the user is preparing IEP goals, progress reports, evaluation summaries, or parent communications, apply these principles automatically.
