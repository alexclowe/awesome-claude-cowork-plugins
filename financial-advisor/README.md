...
| Command | Description |
|---------|-------------|
| `/plan-summary` | Generate plain-language financial plan summaries that clients can understand and reference |
...
This plugin includes skills that activate automatically when you're working on financial advisory tasks:
...
```
/plan-summary
Client: "Michael and Sarah Chen," ages 45 and 43. Combined income $280K.
Goals: retire at 62, fund college for 2 kids (ages 10, 13). Current savings:
$650K in 401ks, $120K in Roth IRAs, $85K in 529s, $200K taxable. Saving
15% of income. Mortgage: $380K remaining. No other debt. Term life on
both. No estate documents. Recommend: increase to 20% savings, add
umbrella insurance, create wills and revocable trust.
```
...
```
/recommendation-memo
Recommending Roth conversion strategy for "David Wright," age 55, recently
early-retired. Current income: $0 (living off savings). Has $800K in
traditional IRA, $200K in Roth, $300K taxable. Tax bracket: 12% this year.
Recommend converting $80K/year for 5 years before Social Security starts.
This fills the 22% bracket. Trade-off: pay tax now at low rate vs higher
rate later with RMDs. Risk: tax rates could decrease, market drop after
conversion.
```
