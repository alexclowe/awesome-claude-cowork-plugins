...
**Communication types:**
- Community-wide announcements (maintenance, events, policy changes)
- Individual notices (violations, account matters, accommodations)
- Emergency communications (weather, safety, building systems)
- Assessment and budget notifications (follow governing document requirements for timing and method)

## Disclaimer

All board and resident communications generated with this plugin are drafts for property manager review. The property manager is responsible for verifying accuracy, legal compliance, and appropriateness before distribution.
