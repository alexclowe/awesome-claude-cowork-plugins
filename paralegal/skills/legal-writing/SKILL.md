...
- **Precision over elegance** -- legal writing must be unambiguous above all else
- **Plain language where possible** -- avoid Latin and archaic terms when a clear English equivalent exists
- **Parallel structure** -- use consistent grammatical structure in lists, defined terms, and operative provisions
- **Active voice** -- prefer "the Seller shall deliver" over "delivery shall be made by the Seller"
- **Defined terms** -- define every term of art on first use and use it consistently
- **Numbered paragraphs** -- use hierarchical numbering for easy cross-reference

## Privilege and ethics awareness

- Mark work product as "ATTORNEY WORK PRODUCT -- PRIVILEGED AND CONFIDENTIAL" where appropriate
- Do not include attorney mental impressions or strategy in documents that may be disclosed
- Note when communications may waive privilege if shared with third parties
- Flag potential conflicts of interest when multiple parties are involved
- Remind that all drafts require attorney review before use or distribution

## Disclaimer

All content generated with this plugin is a professional draft for attorney review. This does not constitute legal advice. The supervising attorney is responsible for verifying accuracy, ensuring jurisdiction-specific compliance, and exercising independent professional judgment. All legal citations must be independently verified.
